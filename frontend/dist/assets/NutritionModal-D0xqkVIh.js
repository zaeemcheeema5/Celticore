import{c as y,u as ee,r as a,j as e,m as te,L as I,U as M,b as ae,M as se,n as re,k as ne,q as ie,s as le,t as n}from"./index-BPcpGvHR.js";import{A as E,S as oe,n as ce}from"./nutrition-DH_twdxQ.js";import{A as O}from"./arrow-right-CsBJiaqt.js";import{M as de}from"./message-square-C_fqNV3S.js";import{A as me}from"./arrow-left-ICELohag.js";import{L as xe}from"./loader-circle-DtA8f36f.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fe=[["path",{d:"M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",key:"c3ymky"}],["path",{d:"M3.22 12H9.5l.5-1 2 4.5 2-7 1.5 3.5h5.27",key:"1uw2ng"}]],H=y("heart-pulse",fe);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ue=[["path",{d:"M21.3 15.3a2.4 2.4 0 0 1 0 3.4l-2.6 2.6a2.4 2.4 0 0 1-3.4 0L2.7 8.7a2.41 2.41 0 0 1 0-3.4l2.6-2.6a2.41 2.41 0 0 1 3.4 0Z",key:"icamh8"}],["path",{d:"m14.5 12.5 2-2",key:"inckbg"}],["path",{d:"m11.5 9.5 2-2",key:"fmmyf7"}],["path",{d:"m8.5 6.5 2-2",key:"vc6u1g"}],["path",{d:"m17.5 15.5 2-2",key:"wo5hmg"}]],ge=y("ruler",ue);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const be=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["circle",{cx:"12",cy:"12",r:"6",key:"1vlfrh"}],["circle",{cx:"12",cy:"12",r:"2",key:"1c9p78"}]],W=y("target",be),S=[{id:"identity",label:"Identity",icon:M},{id:"vitals",label:"Vitals",icon:E},{id:"objective",label:"Objective",icon:W},{id:"wellbeing",label:"Wellbeing",icon:H}],Se=({isOpen:_=!0,onClose:i})=>{if(!_)return null;const{user:l}=ee(),[o,v]=a.useState(""),[c,j]=a.useState(""),[d,C]=a.useState(""),[m,z]=a.useState(""),[x,$]=a.useState("Male"),[p,A]=a.useState(""),[h,B]=a.useState(""),[f,G]=a.useState("Muscle Gain"),[u,V]=a.useState("Moderate"),[g,T]=a.useState("Vegetarian"),[P,L]=a.useState(""),[D,q]=a.useState(""),[k,F]=a.useState(!1),[s,N]=a.useState(0),b=a.useRef(null),Y=a.useRef(null);a.useEffect(()=>{l?(v(l.name||""),j(l.email||"")):(v(""),j(""))},[l]);const U=()=>{var t;(t=b.current)==null||t.scrollIntoView({behavior:"smooth",block:"start"})},Z=t=>t===0&&(!o.trim()||!c.trim()||!d.trim())?(n.error("Please share your name, email and phone number."),!1):t===1&&(!m.trim()||!x.trim()||!p.trim()||!h.trim())?(n.error("Please complete your vitals to continue."),!1):t===2&&(!f.trim()||!u.trim()||!g.trim())?(n.error("Please tell us your objective to continue."),!1):!0,K=()=>{var t;Z(s)&&(N(r=>Math.min(r+1,S.length-1)),(t=b.current)==null||t.scrollIntoView({behavior:"smooth",block:"start"}))},J=()=>{var t;N(r=>Math.max(r-1,0)),(t=b.current)==null||t.scrollIntoView({behavior:"smooth",block:"start"})},Q=async t=>{if(t.preventDefault(),!o.trim()||!c.trim()||!d.trim()||!m.trim()||!x.trim()||!p.trim()||!h.trim()||!f.trim()||!u.trim()||!g.trim()){n.error("Please fill in all the required fields.");return}F(!0);try{await ce.submitRequest({name:o,phone:d,email:c,age:Number(m),gender:x,weight:Number(p),height:Number(h),goal:f,activity_level:u,diet_preference:g,medical_conditions:P,notes:D}),n.success("Nutrition advice request submitted! Our trainers will review and send you an email."),C(""),z(""),A(""),B(""),L(""),q(""),N(0),i==null||i()}catch(r){n.error(r.message||"Failed to submit request.")}finally{F(!1)}};return e.jsxs("div",{className:"nc-root",children:[e.jsx("style",{children:`
